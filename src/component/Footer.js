    ...
    <footer class="footer-distributed">
      <div class="footer-left">
        <h3>
          <FaHamburger
            size="80"
            style={{ color: "red", display: "inline-flex", margin: "0 10px" }}
          />
          Burger Bar
        </h3>
        ...
        <p class="footer-company-name">Manisha Mantri&copy; 2021</p>
      </div>
      ...
      <div class="footer-center">
        ...
        <div>
          <MdEmail />
          <p>
            <a href="mailto:support@company.com">infoburgerbar@gmail.com</a>
          </p>
        </div>
      </div>
